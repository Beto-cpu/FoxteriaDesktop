...
const TextField = ({ name, label, isPassword, vertical, onKeyDown }) => {
    ...
    return (
        <div className="flex flex-row justify-between text-2xl space-x-3 w-full">
            ...
            <div className='relative'>
                <input name={name} type={(showPassword || !isPassword)? "text" : "password"}  className="border border-gray-400 rounded px-3 py-1" onKeyDown={onKeyDown}/>
                {
                    isPassword &&
